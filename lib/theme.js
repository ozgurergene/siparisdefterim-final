export const colors = {
  light: {
    bg: '#f5e6fb',
    bgGradient: 'linear-gradient(135deg, #9333ea 0%, #c026d3 50%, #db2777 100%)',
    bgCard: 'linear-gradient(135deg, rgba(248, 232, 250, 0.65) 0%, rgba(238, 232, 255, 0.65) 100%)',
    bgCardHover: 'linear-gradient(135deg, rgba(248, 232, 250, 0.8) 0%, rgba(238, 232, 255, 0.8) 100%)',
    header: 'rgba(248, 232, 250, 0.55)',
    text: '#1a1a2e',
    ...
    inputBorder: 'rgba(192, 132, 252, 0.2)',
    bgSecondary: 'rgba(245, 243, 255, 0.5)',

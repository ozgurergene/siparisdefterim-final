      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '10px' }}>
        ...
        <div>
          <button
            ...
            style={{ padding: '8px 15px', background: '#6c757d', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '16px', marginTop: '23px' }}
          >
            Temizle
          </button>
        </div>
      </div>
      <p style={{ margin: '10px 0 0 0', fontSize: '16px', color: c.textSecondary }}>Bulunan: {filteredCount} sipariş</p>
    </div>
  )
}